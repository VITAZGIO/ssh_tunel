...
//     ("CONNECT api.anthropic.com:443"), а не адрес. Значит имя разрешает
//     сервер, и DNS-запрос не уходит с машины мимо туннеля. При SOCKS многие
//     приложения резолвят имя сами, до обращения к прокси, и такой запрос
//     уходит наружу напрямую.
